...
- We hope that the revisions explanding review material and clarification of our contributions to the topic will meet the standards of your publication. An R-package with binning, loss and plotting fuctions is available through an author's Github repository; however linking directly would not allow for blinded review. As such the functions used are provided in a supplementary R file. Additionally, a zipped folder containing an Rproj file for launching the Rpackage locally can be made available if desired. If there are any additional comments, concerns or questions, our team is happy to address them.
