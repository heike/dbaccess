...
\author{Karsten Maurer$^1$, Susan VanderPlas$^2$, Heike Hofmann$^{2,3}$\\$^1$Department of Statistics, Miami University \\$^2$Department of Statistics, Iowa State University \\$^3$Human Computer Interaction, Iowa State University}
  \maketitle
} \fi
...
qplot(data=pitchdat, x=G, y=SO, geom="point", alpha=I(.05), size=I(3)) + theme_bw() + xlab("Games (Count)")+ ylab("Strike Outs (Count)")
  ggsave("./figure/OverplottingAlpha.png", width=5, height=5, dpi=900)
  
# Open Circle Scatter
qplot(data=d1, x=G, y=SO, geom="point", size=I(3)) + theme_bw() + xlab("Games (Count)")+ ylab("Strike Outs (Count)")
  ggsave("./figure/Overplotting.png", width=5, height=5, dpi=900)
...
# Alpha Blended Scatter
  ...
  ggsave("./figure/OverplottingCircles.png", width=5, height=5, dpi=900)
...
# Hex binned scatterplot
  ...
  ggsave("./figure/HexBinning.png", width=5, height=5, dpi=900)
...
ggsave("./figure/BinBubble.png", width=5, height=5, dpi=900)

# minimally binned rectangular  
qplot(G, SO, geom="tile", fill=Freq, data=d1) +
  scale_fill_gradient("Frequency", low="#56B1F7", high="#132B43", guide="legend", trans="log", breaks=c(1, 10, 100, 1000)) + theme_bw() + xlab("Games (Count)") + ylab("Strike Outs (Count)") + theme(legend.position="bottom")
  ggsave("./figure/BinScatter.png", width=5, height=5, dpi=900)
...
%' 
%' ggsave("./figure/ShadeContextDemo.png",width=5, height=5, dpi=600)
%' @
...
#ggsave("./figure/FreqBinDemo.png",width=5, height=1.5, dpi=600)
@
...
ggsave("./figure/SimScatters.png", width=8, height=5.5, dpi=900)
@
\begin{figure}[hbtp]
\begin{center}
...
<<SpatialLossCompare,echo=F,include=T,eval=T,fig.width=8, fig.height=5, out.width='.8\\linewidth', fig.pos='h',fig.align='center',tidy=F, cache=TRUE, fig.show='hold',fig.cap="Lineplots for net spatial loss and computation times over a range of bin sizes for standard and random binning of the fine version of the simulated data from each bivariate distribution.">>= 
...
ggsave(filename = "./figure/AlphaScatterAirline2014.png", width= 6, height=6, dpi=900)
@
...
ggsave(filename = "./figure/MinimalBinnedAirline2014.png", width= 6.5, height=6, dpi=900)
@
