...
<<UniformStripes, echo=F,include=T,eval=T,fig.width=7, fig.height=3, out.width='.99\\linewidth', fig.pos='h',fig.align='center',tidy=F, cache=TRUE, fig.show='hold',fig.cap="Binned scatterplots of coarse uniform data.">>= 
