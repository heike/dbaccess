...
\begin{figure}[h]
  ...
  \subfloat[Hexagonal binned bubble plot]{\includegraphics[keepaspectratio=TRUE,width=.32\textwidth]{./figure/BinBubble.png}}
  \subfloat[Minimally binned scatterplot]{\includegraphics[keepaspectratio=TRUE,width=.32\textwidth]{./figure/BinScatter.png}} 
