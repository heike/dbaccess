...
\begin{figure}[hbtp]
    \centering
		\subfloat[Spatial Loss]{\includegraphics[keepaspectratio=true, width=.54\textwidth]{./figure/Binning-DataVisualNumericalCenter}}
...
<<LossTableGraphs,echo=F,results="hide",cache=TRUE,fig.keep='none'>>=
# connect <- dbConnect(dbDriver("MySQL"), user="2009Expo", 
#                    password="R R0cks", port=3306, dbname="baseball", 
#                    host="headnode.stat.iastate.edu")
# pitch <- new("dataDB", co=connect, table="Pitching")
...
\includegraphics[keepaspectratio=true, width=.9\textwidth]{figure/RandomStd210.pdf}
}\\
\subfloat[(5, 25) tiling of G, SO data]{
\includegraphics[keepaspectratio=true, width=.9\textwidth]{figure/RandomStd525.pdf}
}
