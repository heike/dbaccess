...
For the bivariately skewed exponential data, the 1 unit origin offset minimized net loss for the smaller intervals but was not optimal for the largest intervals; 2.5\% and 7\% increase the minimum spatial loss for bins of size eight and ten, respectively.
